...
*** Variables ***
#-----------------JSON------------------------------------------------
${cancellation_json_file_path}  ${execdir}\\UploadExcel\\JsonTemplates\\Cancellation.json
...
#${BASE_URL}       https://api.wileyas.qa.viax.io/graphql
${EMPTY}
${Token1}    eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIyczVNbG80eUZVRC1kMzlseXZMUHhYOWJYc2NCZ3ZiaHVLWHpNNU53b3hrIn0..r6hOWtS7nYkL50x8e-5RCQikmZK9hGm30Sn8dQoZpSx2up3-RTfpNH-h6ckXLN_AqoA4HyVJcgr1vDqWZh7pRZJY1ZNcMujRKz2Jpq4IlXQQZg-X0gmAQnAqXl4f5r2hI1ODqUJyo5plcOc0xJrlNqDmFNeF9ymwbuaxHpiGGZvNKKrAZgyXdg7XxmmwdrshSqqTVNJqparrxh2qBezcGrBcNWMeBqjRgbu5u4lVhqe_yGuvtVHDX_zezXUDodKu1maOtkqSZB743UhkZjF10YJuwkYOHHiMRjztD6cr7EZAnxS2otgkiQg9R9dGi1eyVSvbf3cMVQe1zgn6LY01Yg
${response_text}
${True}    True
${END}    END
${LastNameList}
...
#${URL}            https://wileyas.stage.viax.io/orders
#${URL}       https://wileyas.qa.viax.io/orders
${Browser}        chrome
...
${FlagList}
${separator}    _
${TotalAmtText}    (//*[@class="x-col x-col_3 x-pricing-view__col x-pricing-view__value"])[1]
${TaxAmtText}    (//*[@class="x-col x-col_3 x-pricing-view__col x-pricing-view__value"])[3]
#******************************************END OF VIAX***********************************************
                                      #STEP VARIABLES
#******************************LAUNCH AND LOGIN VARIABLES*********************************************
${Var_STEPWebLink}    https://wiley-qa-step.mdm.stibosystems.com/
${Var_UserName}    dchinnasam@wileyqa.com
${Var_Password}    L&df46Dy
${Var_MicrosoftLoginLink}    //*[@id="social-wiley-qa-idp"]//span[@class=""]
...
${Var_WileyQALink}    //*[@title="Wiley QA Web UI"]
...
${Var_InitaiteJournalLink}    (//div[@class="gwt-Label status-selector__initiate-link-wrapper"])[1]
...
${Var_Popuptextbox}    //*[@type="text" and @class="gwt-TextBox FormFieldWidget"]
${Var_JouranlGrpCodeValue}    B42P
...
${Var_ProductIdentifier}    //*[@id="Production_Identifier"]
${Var_VCHIdentifier}    //*[@id="VCH_Identifier"]
${Var_AlternateTitle}    //*[@id="Alternate_Title"]
${Var_FutureTitle}    //*[@id="Future_Title"]
...
Remove Numbers from String
    ${set}=    Set Variable    1,000.00 USD
    ${set_without_last_three}=    Get Substring    ${set}    0    -3    # Get substring from index 0 to 3 characters from the end
    log to console    ${set_without_last_three}
...
##    JS Click Element    ${Var_SelectIcon}
    ...
    Drag And Drop By Offset    ${splitter_element}    0   -550
#    zoom out page
    ...
    IF    '${strCheckFlag}'=='True'
        seleniumlibrary.input text    ${Var_MaterialNumber}    Test
    END
    ${JournalIDCode}=    get text    ${Var_JournalIDCode}
    IF  '${JournalIDCode}'== '${EMPTY}'
        ${RandomString}=    generate random string    4    [UPPER]
        SeleniumLibrary.input text    ${Var_JournalIDCode}    ${RandomString}-0000-0000-P
    END
    select from list by value    ${Var_publicationtype}    AG
    seleniumlibrary.input text    ${Var_JournalMediaProduct}    Test
    Execute Javascript    window.scrollBy(0, 1000);
    JS Click Element    //*[@id="Content_Category"]//*[contains(@id,"gwt-uid-")]
    select from list by value    ${Var_FIDivision}    RE
    seleniumlibrary.input text    ${Var_ExternalMatGrp}    Test
    ...
    IF    '${strCheckHomewarehouse}'=='True'
        select from list by value    ${Var_EntitledForm}    CW
    ELSE
        select from list by value    ${Var_HomeWarehouseForm}    F
    END
    select from list by value    ${Var_OneSourceCodeTax}    AC
...
#    sleep    5s
    ...
    JS Click Element    //div[@title="Clear all"][1]
#    sleep    5s
...
JS Click Element
	...
	${eleFound}=    Run keyword and return status    Wait until page contains element    ${ele}    3s
...
Upload the form
    [Arguments]    ${ExcelForm}
    wait until element is visible    ${Var_selectfile}
...
Lanch and Login STEP
    ...
    SeleniumLibrary.click element    ${Var_NextandSignButton}
    wait until element is visible    ${Var_WileyQALink}
...
Navigate to Manual Enrichment and Update details
    ...
    SeleniumLibrary.input text    ${var_journalownedby}    Test
    #ownership status
    select from list by index    ${Var_Ownershipped}    3
    #copyright
    SeleniumLibrary.input text    ${Var_Copyright}    Test
    #Launch year
    SeleniumLibrary.input text    ${Var_LauchYear}    2024
    #media type
    select from list by index    ${Var_MediaType}    1
    #Revenue mode
    select from list by index    ${Var_RevenueModel}    1
    #Reneval subs type
    select from list by index    ${var_ReneSubsType}    1
    #billing Model
    select from list by index    ${Var_BillingModel}    1
    SeleniumLibrary.Click Element    ${Var_TrueCheckbox}
    SeleniumLibrary.Click Element    ${Var_JouranlProductTypeCheckBox}
    JS Click Element    ${Var_SaveButton}
    wait until element is visible    ${Var_SalesTab}
    JS Click Element    ${Var_SalesTab}
    wait until element is visible    ${Var_SalesWileyRadio}
    JS Click Element    ${Var_SalesWileyRadio}
    wait until element is visible    ${Var_SaveButton}
    JS Click Element    ${Var_SaveButton}
#    sleep    2s
...
Update VCH Identifier
    ...
    seleniumlibrary.input text    //*[@id="Future_Effective_Date"]    ${todaydate}
...
#    set selenium speed    2s
    seleniumlibrary.click element    //span[text()="Finance Controls"]
